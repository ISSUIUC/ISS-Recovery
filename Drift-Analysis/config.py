...
MAIN_ALTITUDE = u.Measurement(2500, u.Unit.FEET) # Main parachute deployment altitude
APOGEE_OFFSET = u.Measurement(1, u.Unit.FEET) # Used to simulate off-nominal deployment. DO NOT CHANGE unless off nominal is more than +1'
...
# variables, local use
ROCKET_MASS_BOOSTER = u.MassMeasurement(30.37, u.UMass.LB) # Mass of the rocket
ROCKET_MASS_SUSTAINER = u.MassMeasurement(16.38, u.UMass.LB) # Mass of the rocket

APOGEE_ALTITUDE_BOOSTER = u.Measurement(30000, u.Unit.FEET) # Apogee deployment altitude
APOGEE_ALTITUDE_SUSTAINER = u.Measurement(100000, u.Unit.FEET) # Apogee deployment altitude
